...
public class UmowaDzielo extends AppCompatActivity {
    private double REQUEST_CODE = 3;
    ...
    private double CalculateSalary(double salary) {
        ...
        double podstawa = salary - (salary * 0.2);
        int pod_zaokraglenie = (int) (podstawa + 0.5);
        double zaliczka = pod_zaokraglenie * 0.17;
        int zal_zaokraglenie = (int) (zaliczka + 0.5);
        netto = salary - zal_zaokraglenie;
